...
export function initHomeMotion() {
  ...
  mm.add('(prefers-reduced-motion: no-preference)', () => {
    ...
    intro
      .from(letters[0], { yPercent: compact ? 68 : 92, duration: 0.9 }, 0.04)
      ...
      .from(letters[1], { scale: compact ? 0.78 : 0.68, clipPath: compact ? 'inset(38% 10% 38% 10%)' : 'inset(48% 12% 48% 12%)', opacity: 0, duration: 0.86 }, 0.14)
      .from(letters[2], { yPercent: compact ? 52 : 72, rotate: compact ? -15 : -24, transformOrigin: '52% 76%', duration: 1.02 }, 0.22)
      .from('[data-hero-matter="motion"]', { xPercent: compact ? -44 : -76, rotate: compact ? -8 : -13, scaleY: 0.72, opacity: 0, duration: 0.92 }, 0.28)
      .from(letters[3], { xPercent: compact ? 38 : 54, yPercent: -10, duration: 0.84 }, 0.34)
      .from('[data-hero-matter="flavour"]', { xPercent: compact ? 32 : 48, yPercent: compact ? 22 : 34, rotate: compact ? -11 : -16, scale: 0.9, opacity: 0, duration: 1.02 }, 0.4)
